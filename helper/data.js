import staticCuriee from "../public/curiee.png";
import curiee from "../public/curiee.gif";
...
const projectData = [
  {
    ...
    description:
      "Curiee is a full-stack web application for therapists to assign personalized treatments and patients to explore new treatment modals. Optimized treatment tracking, ratings, and favorites for enhanced healthcare experiences.",
    images: {
      static: staticCuriee,
      dynamic: curiee,
    },
    url: "https://curiee-app.vercel.app/",
    hasLiveApp: true,
    github: "https://github.com/tarikozturk017/Curiee",
  },
  {
    name: "AuctionHub | Online Auction/Shopping Web Application",
    technologies: ["javascript", "React", "Django", "Python", "CSS", "HTML"],
    description:
      "AuctionHub is an online auction/shopping web application where you can bid the existing listings. You can add an item to your watchlist, comment on listings, create a listing, search items, and more features.",
    images: {
  ...
  },
  {
    ...
    description:
      "PlanetBlue is a shooting game, which users can register and track their score. Users can see their top scores as well as their standings on the leadership board. The game becomes harder every time the user levels up. ",
    images: {
      static: planetBlue,
    ...
    hasLiveApp: false,
    github:
      "https://github.com/tarikozturk017/PlanetBlue-Browser-shooting-game",
  },
  {
  ...
  },
  {
    ...
    technologies: ["React", "JavaScript", "CSS"],
    description:
      "Pomodoro Clock is a browser based timer, where you can set your session time, and break time. The alarm starts beeping at the end of the session time and break time. This application enables users to work/study more efficiently.",
    images: {
      static: pomodoro,
      dynamic: pomodoroGif,
    },
  ...
  },
  {
    ...
    technologies: ["React", "JavaScript", "CSS"],
    description:
      "This web application randomly generates quotes from famous people.",
    images: {
  ...
  },
  {
    ...
    technologies: ["React", "JavaScript", "CSS"],
    description:
      "Calculator is an application where you can do the mathematical operations.",
    images: {
      static: calculator,
...

  {
    ...
    technologies: ["C++"],
    description:
      "Aid management system manages the list of items needed to be shipped to places. It is an application where users can keep track of perishable and non-perishable items. I used C++ classes, dynamic memory allocation, operation overload, and more to create this application. This application allows you to read, write, update from/to file. (This project does not have a UI.)",
    images: {
      static: code,
      dynamic: code,
    },
  ...
  },
  {
    ...
    description:
      "Employee management system allows you to apply CRUD on Oracle NoSQL Database. It allows users to find, add, update, remove employee. Additionally, it retrieve employee data from the database. (This project does not have a UI.)",
    images: {
      static: code,
      dynamic: code,
    },
  ...
  },
  {
    ...
    technologies: ["C"],
    description:
      "Account ticketing system is an application where the users can track reported tickets. Each tickets contain certain problems and its description. The user can also manage tickets, and persist data. (This project does not have a UI.)",
    images: {
      static: code,
      dynamic: code,
    },
  ...
  },
  {
    ...
    hasLiveApp: false,
    github:
      "https://github.com/tarikozturk017/assembly-workstation/tree/main/ms33",
  },
  {
    name: "School Database Management System",
    technologies: ["JavaScript", "express", "PostgreSQL"],
    description:
      "This application allows users to apply CRUD on the relational database system. Users can query, add, delete, update student and course data from the database. This is mainly a backend web application with a basic UI.",
    images: {
      static: code,
      dynamic: code,
    },
